/**
 * @fileoverview Khai báo endpoint, middleware bảo vệ và tài liệu Swagger cho nhóm API staffRoleRequest.routes.
 *
 ...
 * Phạm vi sử dụng: src/routes/staffRoleRequest.routes.js.
 */
...
/**
 * Khai báo `staffRoleRequestController` để nạp module phụ thuộc để sử dụng dịch vụ, hằng số hoặc hàm hỗ trợ mà tệp này cần.
 * Phạm vi sử dụng: src/routes/staffRoleRequest.routes.js.
 */
